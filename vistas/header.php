...
<head>
    ...
    <title>Copa Navidad | Torneo Deportivo y Evento Navideño</title>
    <meta name="description" content="Copa Navidad es un evento deportivo y festivo donde Colegios y equipos compiten en un ambiente de celebración. Consulta horarios, resultados y más.">

    <!-- 🔹 Palabras clave (útiles si el sitio es público) -->
    <meta name="keywords" content="Copa Navidad, torneo, deporte, navidad, evento Colegial, fútbol, celebración, equipos, competencia, padel, basketball, Tenis, tenis de mesa">

    <!-- 🔹 Autor -->
    <meta name="author" content="Colegio Real Royal School">
