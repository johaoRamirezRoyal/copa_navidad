...
<style>
 ...
 .team-emoji{ font-size:1.05em; }
    ...
    /* Estilos para el botón animado a la izquierda */
    .title-row {
        position: relative;
        display: flex;
        align-items: center;
    ...
    .animated-left-btn:hover {
        box-shadow: 10px 10px 0 #1417a8ff;
        transform: skewX(-20deg) translateY(-3px) scale(1.02);
    }
    .animated-left-btn .btn-text {
        transform: skewX(10deg);
        display: inline-block;
        letter-spacing: 1px;
    }
    ...
    <div class="container" style="margin-top: 100px; padding-top: 18px;">
        <div class="title-row">
                        <!-- Título centrado (misma animación) -->
            <div class="styled-title">
                <span class="title-text animate-title">Teams</span>
            </div>
            <!-- Botón animado a la izquierda -->
            <a href="#" class="animated-left-btn" role="button" aria-label="Volver">
                <span class="btn-text">Show all teams</span>
            </a>
        </div>
